...
def get_boundings_size(prop_json, object_dir, output_file):
...
def check_intersection_list(centres_list, size_list, margin):
    # Check whether bounding boxes of objects intersect
...
def check_intersection(box1, box2):
    ...
    for box in boxes:
        for i in range(len(box)):
            ...
            perp_line = {'x': vertex2['y'] - vertex1['y'], 'y': vertex2['x'] - vertex1['x']}
